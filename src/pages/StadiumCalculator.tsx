...
function StadiumCalculator() {
  ...
  useEffect(() => {
    ...
    if (teamId) {
      ...
      accessElf.track("Stadium Calculator", teamId);
    }
  }, [searchParams]);
  ...
  useEffect(() => {
    localStorage.setItem(
      "brtools-current-stadium",
      JSON.stringify(currentStadium)
    );
  }, [currentStadium]);
              ...
              <tbody>
                <tr>
                  ...
                  <td className="px-4 py-2 border-t text-right">
                    <input
                      ...
                      onChange={(e) =>
                        handleCurrentStadiumChange("standing", e.target.value)
                      }
                ...
                <tr>
                  ...
                  <td className="px-4 py-2 border-t text-right">
                    <input
                      ...
                      onChange={(e) =>
                        handleCurrentStadiumChange("uncovered", e.target.value)
                      }
                      className="w-24 px-2 py-1 border border-gray-300 rounded-md text-right"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-2 border-t text-right">
                    <input
                      ...
                      onChange={(e) =>
                        handleCurrentStadiumChange("covered", e.target.value)
                      }
                      className="w-24 px-2 py-1 border border-gray-300 rounded-md text-right"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-2 border-t text-right">
                    <input
                      ...
                      onChange={(e) =>
                        handleCurrentStadiumChange("members", e.target.value)
                      }
                      className="w-24 px-2 py-1 border border-gray-300 rounded-md text-right"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-2 border-t text-right">
                    <input
                      ...
                      onChange={(e) =>
                        handleCurrentStadiumChange("corporate", e.target.value)
                      }
                      className="w-24 px-2 py-1 border border-gray-300 rounded-md text-right"
                    />
                  </td>
                ...
                <tr className="font-bold">
                  ...
                  <td className="px-4 py-2 border-t text-right">
                    {smallStadiumTotal}
                    {smallStadiumTotal &&
                      calculateDifference(smallStadiumTotal, currentTotal)}
                  </td>
                  <td className="px-4 py-2 border-t text-right">
                    {largeStadiumTotal}
                    {largeStadiumTotal &&
                      calculateDifference(largeStadiumTotal, currentTotal)}
                  </td>
                </tr>
              </tbody>
            </table>
