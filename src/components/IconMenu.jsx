      ...
      <div className="flex justify-center space-x-6">
        ...
        <div className="relative">
          <Link
            to="/scouting"
            className="block p-2 hover:bg-gray-100 rounded-lg transition-colors"
            onMouseEnter={() => setShowScoutingTooltip(true)}
            onMouseLeave={() => setShowScoutingTooltip(false)}
          >
            <ScoutingIcon
              width={32}
              height={32}
        ...
        <div className="relative">
          <Link
            to="/internationals"
            className="block p-2 hover:bg-gray-100 rounded-lg transition-colors"
            onMouseEnter={() => setShowInternationalsTooltip(true)}
            onMouseLeave={() => setShowInternationalsTooltip(false)}
          >
            <InternationalsIcon
              width={32}
              height={32}
